		...
		while not self.stopScan:
			...
			if len(rascan.templates) > 0:
				if self.__capture_the_lights__():
					...
					p0 = threading.Thread(name="TP0", target=self.processor, args=(rascan.templates, 0,))
					p0.start()
					thread.join(p0)
					p1 = threading.Thread(name="TP1", target=self.processor, args=(rascan.templates, 1,))
					p1.start()
					thread.join(p1)
					p2 = threading.Thread(name="TP2", target=self.processor, args=(rascan.templates, 2,))
					p2.start()
					thread.join(p2)
					p3 = threading.Thread(name="TP3", target=self.processor, args=(rascan.templates, 3,))
					p3.start()
					thread.join(p3)
					p4 = threading.Thread(name="TP4", target=self.processor, args=(rascan.templates, 4,))
					p4.start()
					thread.join(p4)
					p5 = threading.Thread(name="TP5", target=self.processor, args=(rascan.templates, 5,))
					p5.start()
					thread.join(p5)
					p6 = threading.Thread(name="TP6", target=self.processor, args=(rascan.templates, 6,))
					p6.start()
					thread.join(p6)
					p7 = threading.Thread(name="TP7", target=self.processor, args=(rascan.templates, 7,))
					p7.start()
					thread.join(p7)
					p8 = threading.Thread(name="TP8", target=self.processor, args=(rascan.templates, 8,))
					p8.start()
					thread.join(p8)
					p9 = threading.Thread(name="TP9", target=self.processor, args=(rascan.templates, 9,))
					p9.start()
					thread.join(p9)
