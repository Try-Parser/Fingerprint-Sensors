		...
		while not self.stopScan:
			...
			if len(rascan.templates) > 0:
				if self.__capture_the_lights__():
					...
					p0 = threading.Thread(name="p0", target=self.processor, args=(rascan.templates, 0,))
					p1 = threading.Thread(name="p1", target=self.processor, args=(rascan.templates, 1,))
					p2 = threading.Thread(name="p2", target=self.processor, args=(rascan.templates, 2,))
					p3 = threading.Thread(name="p3", target=self.processor, args=(rascan.templates, 3,))
					p4 = threading.Thread(name="p4", target=self.processor, args=(rascan.templates, 4,))
					p5 = threading.Thread(name="p5", target=self.processor, args=(rascan.templates, 5,))
					p6 = threading.Thread(name="p6", target=self.processor, args=(rascan.templates, 6,))
					p7 = threading.Thread(name="p7", target=self.processor, args=(rascan.templates, 7,))
					p8 = threading.Thread(name="p8", target=self.processor, args=(rascan.templates, 8,))
					p9 = threading.Thread(name="p9", target=self.processor, args=(rascan.templates, 9,))
					p0.start()
					p1.start()
					p2.start()
					p3.start()
