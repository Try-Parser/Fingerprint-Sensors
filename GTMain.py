		...
		while not self.stopScan:
			...
			if len(rascan.templates) > 0:
				if self.__capture_the_lights__():
					...
					threading.Thread(name="TP0", target=self.processor, args=(rascan.templates, 0,)).start()
					threading.Thread(name="TP1", target=self.processor, args=(rascan.templates, 1,)).start()
					threading.Thread(name="TP2", target=self.processor, args=(rascan.templates, 2,)).start()
					threading.Thread(name="TP3", target=self.processor, args=(rascan.templates, 3,)).start()
					threading.Thread(name="TP4", target=self.processor, args=(rascan.templates, 4,)).start()
					threading.Thread(name="TP5", target=self.processor, args=(rascan.templates, 5,)).start()
					threading.Thread(name="TP6", target=self.processor, args=(rascan.templates, 6,)).start()
					threading.Thread(name="TP7", target=self.processor, args=(rascan.templates, 7,)).start()
					threading.Thread(name="TP8", target=self.processor, args=(rascan.templates, 8,)).start()
					threading.Thread(name="TP9", target=self.processor, args=(rascan.templates, 9,)).start()
